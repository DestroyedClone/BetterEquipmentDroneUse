    ...
    public class SystemInitializers
    {
        ...
        public static void SetupDictionary()
        {
            DroneModeDictionary = new Dictionary<EquipmentIndex, DroneMode>()
            {
                ...
                // If there is a priority target, such as an Elite. More expensive //
                ...
                //If our strength is to evade and gain attention from enemies //
                ...
                // Suicidal, will try to go for the strongest enemy //
                [RoR2Content.Equipment.QuestVolatileBattery.equipmentIndex] = DroneMode.FuelArray,


                [DLC1Content.Equipment.BossHunter.equipmentIndex] = DroneMode.TargetBoss,

                [DLC1Content.Equipment.BossHunterConsumed.equipmentIndex] = DroneMode.None,

                [DLC1Content.Equipment.GummyClone.equipmentIndex] = DroneMode.None,

                [DLC1Content.Equipment.Molotov.equipmentIndex ] = DroneMode.None,
                [DLC1Content.Equipment.VendingMachine.equipmentIndex ] = DroneMode.None
            };
